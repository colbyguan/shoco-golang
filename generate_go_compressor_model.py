...
"""
TWO_TAB_SPACING = "        "
PACK_LINE = "{{ {word:#x}, {packed}, {unpacked}, [8]uint{{ {offsets} }}, [8]int16{{ {masks} }} }}"
...
def main():
    ...
    out = TABLE_GOLANG.format(
        ...
        successors_reversed=("},\n " + TWO_TAB_SPACING + "{").join(format_int_line(l) for l in successors_reversed.values()),
        chrs_by_chr_and_successor_id=("},\n" + TWO_TAB_SPACING + "{").join(format_chr_line(l) for l in chrs_by_chr_and_successor_id),
